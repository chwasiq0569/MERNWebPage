...
const DB = 'mongodb+srv://wasiq:wasiq@cluster0.xgjzx.mongodb.net/mernwebpage?retryWrites=true&w=majority';
...
//     next()9
// }
// mongoose.connect(DB).then(() => console.log("CONNECTION SUCCESSFULL")).catch(() => console.log("ERROR OCCURED"))
// app.use(middleware)
